...
const ChatInput = ({ onSend, isProcessing = false, isListening = false, onMicToggle, onVoiceInput }: ChatInputProps) => {
  ...
  return (
    <motion.div
      ...
      className="anay-panel p-3 sm:p-4 flex-shrink-0"
    >
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex-1 relative">
          <Input
            ...
            className="w-full font-rajdhani rounded-2xl px-4 sm:px-5 py-3 sm:py-3.5 bg-secondary/50 border-border/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all duration-300"
